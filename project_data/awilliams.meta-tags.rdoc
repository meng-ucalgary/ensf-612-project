...
This fork, adds the option to append data to the metas already defined, so you could split the metas logic in various places, for example defining a set of keywords in one view, and appending more in a partial.
